                        ...
                        <Table>
                            ...
                            <tbody className='searchable'>
                                <NodeCypherLink
                                    ...
                                    target={objectid}
                                    baseQuery={
                                        'MATCH p=(s:IPASudoGroup {objectid: $objectid})-[r1:IPAMemberOf {allow: true}]->(n:IPASudoRule)'
                                    }
                                    start={label}
                                />
                                <NodeCypherLink
                                    ...
                                    target={objectid}
                                    baseQuery={
                                        'MATCH p=(s:IPASudoGroup {objectid: $objectid})-[r1:IPAMemberOf {allow: false}]->(n:IPASudoRule)'
                                    }
                                    start={label}
                                />
                            </tbody>
