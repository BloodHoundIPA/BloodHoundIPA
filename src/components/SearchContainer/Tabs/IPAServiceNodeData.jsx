...
const IPAServiceNodeData = () => {
    ...
    const nodeClickEvent = (type, id, blocksinheritance, domain) => {
        if (type === 'IPAService') {
            ...
            session
                .run(`MATCH (n:IPAService {objectid: $objectid}) RETURN n AS node`, {
                    objectid: id,
                })
                .then((r) => {
...
IPAServiceNodeData.propTypes = {};
export default withAlert()(IPAServiceNodeData);
